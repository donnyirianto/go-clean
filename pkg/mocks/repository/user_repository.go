...
func (_m *UserRepository) Delete(ctx context.Context, user domain.User) error {
	ret := _m.Called(ctx, user)
...
func (_m *UserRepository) GetMatchName(ctx context.Context, text string) ([]domain.User, error) {
...
func (_m *UserRepository) UpdateByID(ctx context.Context, id string, user domain.User) (domain.User, error) {
